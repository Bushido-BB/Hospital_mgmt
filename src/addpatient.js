                        ...
                        <form>
                                    ...
                                    <div className="form-group">
                                        ...
                                        <div className="profile-upload">
                                            <div className="upload-img">
                                                <img alt="" src={require("./img/user.jpg")}/>
                                            </div>
                            ...
                            <div className="form-group">
                                ...
                                <div className="form-check form-check-inline">
                                    <input className="form-check-input" type="radio" name="status" id="patient_active"
                                ...
                                <div className="form-check form-check-inline">
                                    <input className="form-check-input" type="radio" name="status" id="patient_inactive"
                                        value="option2"/>
